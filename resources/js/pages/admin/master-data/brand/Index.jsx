...
export default function BrandIndexPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (isEdit) {
                await axios.put(`/admin/brand/${editingId}`, form);
                setSuccess("Brand berhasil diperbarui.");
            } else {
                await axios.post("/admin/brand", form);
    ...
    const handleDelete = async (row) => {
        const confirmed = window.confirm(`Hapus brand "${row.brand}"?`);
        ...
        try {
            await axios.delete(`/admin/brand/${row.id}`);
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="mt-2 max-w-3xl text-sm font-semibold leading-6 text-slate-500">
                                Kelola data brand atau merek produk yang digunakan
                                pada master produk dan transaksi POS.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                        <div>
                            ...
                            <p className="mt-1 text-sm font-semibold text-slate-500">
                                Menampilkan data brand yang tersimpan.
                            </p>
                        </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-5">
                                <div>
                                    ...
                                    <p className="mt-2 text-xs font-semibold text-slate-400">
                                        Brand digunakan sebagai informasi merek
                                        pada data produk.
                                    </p>
                                </div>
