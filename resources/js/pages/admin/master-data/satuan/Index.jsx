...
export default function SatuanIndexPage() {
    ...
    const fetchRows = async (page = 1) => {
        ...
        try {
            const response = await axios.get("/admin/satuan", {
                params: {
                    page,
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (isEdit) {
                await axios.put(`/admin/satuan/${editingId}`, form);
                setSuccess("Satuan berhasil diperbarui.");
            } else {
                await axios.post("/admin/satuan", form);
    ...
    const handleDelete = async (row) => {
        const confirmed = window.confirm(`Hapus satuan "${row.satuan}"?`);
        ...
        try {
            await axios.delete(`/admin/satuan/${row.id}`);
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="mt-2 max-w-3xl text-sm font-semibold leading-6 text-slate-500">
                                Kelola data satuan produk yang digunakan pada
                                master produk, stok, pembelian, dan transaksi POS.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                        <div>
                            ...
                            <p className="mt-1 text-sm font-semibold text-slate-500">
                                Menampilkan data satuan produk yang tersimpan.
                            </p>
                        </div>
                                            ...
                                            >
                                                <div className="mx-auto flex max-w-md flex-col items-center">
                                                    ...
                                                    <p className="mt-1 text-sm font-semibold leading-6 text-slate-500">
                                                        Tambahkan data satuan pertama
                                                        untuk kebutuhan master produk.
                                                    </p>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-5">
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder="Contoh: pcs, box, dus, unit"
                                    ...
                                    <p className="mt-2 text-xs font-semibold text-slate-400">
                                        Satuan digunakan sebagai ukuran atau unit
                                        pada data produk dan stok.
                                    </p>
                                </div>
